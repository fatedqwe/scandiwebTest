...
<script>
    ...
    const createFurnitureInput = (parentElement) => {
        ...
        inputHeight.setAttribute("onkeydown","return event.keyCode !== 69");
        inputHeight.setAttribute("required", "");
        inputWidth.setAttribute("type", "number");
        inputWidth.setAttribute("onkeydown","return event.keyCode !== 69");
        inputWidth.setAttribute("required", "");
        inputLength.setAttribute("type", "number");
        inputLength.setAttribute("onkeydown","return event.keyCode !== 69");
